package com.shakil.demoweatherapp.weather.view
...
import com.shakil.demoweatherapp.weather.view.adapter.ForecastListAdapter
...
class UserInterface(private val context: Context) {
    ...
    private fun setViewsForTodayInformation(mappedForecastData: ForecastDataMapper) {
        ...
        activity.main_view_precip.text =  mappedForecastData.percipitation
